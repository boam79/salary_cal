...
- ✅ **📰 최신 경제 뉴스** RSS 피드 연동, 5분마다 자동 업데이트
...
### 6️⃣ 경제 뉴스 섹션 (NEW!) 📰
- **RSS 피드 연동**: 연합뉴스, 뉴시스, 매일경제, 머니투데이
- **자동 업데이트**: 5분마다 최신 뉴스 자동 갱신
- **카드 UI**: 제목, 설명, 출처, 날짜, 카테고리 태그
- **이미지 지원**: 썸네일 이미지 표시 (있는 경우)
- **새 창 열기**: 클릭 시 원문 기사 새 창으로 열기
