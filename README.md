...
### v4.0.0 (2025-01-18) - Major UI/UX Improvements & Code Refactoring ✅
...
| 버전 | 날짜 | 주요 변경사항 | 상태 |
|------|------|--------------|------|
| v4.0.0 | 2025-01-18 | 코드 리팩토링, 광고 레이아웃, 로고 클릭 | ✅ 완료 |
| v3.0.0 | 2025-10-15 | 세율 업데이트 (장기요양 12.27%) | ✅ 완료 |
| v2.0.1 | 2024 | UI 최적화, 부동산 계산기 확장 | ✅ 완료 |
| v1.0.0 | 2024 | 초기 릴리스 (5개 계산기) | ✅ 완료 |
